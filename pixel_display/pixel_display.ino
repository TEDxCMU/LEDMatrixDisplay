/*
 * This program is created by TEDxCMU Innovation. We are borrowing the framework of
 * the simple NeoPixel demo here: https://github.com/bigjosh/SimpleNeoPixelDemo
 **/

// Define number of pixels in matrix; can be larger, just will be slightly slower
#define PIXELS 30*22  // # of pixels in the string
